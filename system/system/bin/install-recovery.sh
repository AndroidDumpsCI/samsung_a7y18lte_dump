#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/platform/13500000.dwmmc0/by-name/RECOVERY:34400800:b98ff24d176b8563200a34d03acfc01d5a300919; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/platform/13500000.dwmmc0/by-name/BOOT:25887264:5a0748630a0f470994fd3e5e6ff932c5ed09e1be \
          --target EMMC:/dev/block/platform/13500000.dwmmc0/by-name/RECOVERY:34400800:b98ff24d176b8563200a34d03acfc01d5a300919 && \
